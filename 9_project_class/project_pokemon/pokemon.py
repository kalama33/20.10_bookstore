...
class Pokemon:
    ...
    def show_status(self):
        ...
        if self.counter > 3:
            print(f"{self.name} gave you hard!")
        print()
    
    # increases the Pokemon's magic by a random number between 0 and 200.
    def get_magics(self): 
    ...
    # checks if the Pokemon is alive by checking if its health is greater than 0.
    def is_alive(self): 
